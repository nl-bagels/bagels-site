          ...
          <div className="flex-1 max-w-[584px]">
            ...
            <div className="flex flex-col gap-4">
              <p className="font-['Inter',sans-serif] text-base lg:text-[18px] leading-[1.7] text-black">
                Since 2020, we&apos;ve been bringing authentic New York-style bagels to The Hague.
                Our bagels are hand-rolled, boiled, and baked fresh daily using traditional methods
                and 100% halal, natural ingredients.
              </p>
              <p className="font-['Inter',sans-serif] text-base lg:text-[18px] leading-[1.7] text-black">
                We combine New York&apos;s straightforward approach with Dutch warmth, creating a
                space where everyone feels welcome. No shortcuts, no compromises—just honest,
                delicious bagels made the way they should be.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-10">
              {[
                { icon: '🗽', label: 'NY Recipe' },
                { icon: '🌿', label: '100% Natural' },
                { icon: '✅', label: '100% Halal' },
                { icon: '🎉', label: 'Catering' },
              ].map(({ icon, label }) => (
