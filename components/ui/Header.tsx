        ...
        <nav className="hidden xl:flex items-center gap-6">
          ...
          {whatsappHref && (
            <a
              ...
              className="flex items-center justify-center w-10 h-10 rounded-full bg-[#25D366] hover:bg-[#1ebe5c] transition-colors shrink-0"
            >
          ...
          {orderUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#9b5026] text-white px-6 py-3 text-base font-['Inter',sans-serif] rounded-[12px] hover:bg-[#7d3f1e] transition-colors shrink-0"
            >
              {t('order')}
            </a>
          )}
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#1e170e] text-[#eee6d9] px-6 py-3 text-base font-['Inter',sans-serif] rounded-[12px] hover:bg-[#3a2e22] transition-colors shrink-0"
          >
            {reserveLabel}
          </a>
        </nav>
